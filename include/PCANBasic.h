...
// mod
#define PCAN_ERROR_ILLHW         0x01000  // Hardware handle is invalid
#define PCAN_ERROR_ILLNET        0x01400  // Net handle is invalid
#define PCAN_ERROR_ILLCLIENT     0x01800  // Client handle is invalid
// mod
...
#define PCAN_CHANNEL_ILLEGAL     0x00  // The PCAN-Channel handle is illegal
#define PCAN_CHANNEL_AVAILABLE   0x01  // The PCAN-Channel handle is valid to connect/initialize
#define PCAN_CHANNEL_OCCUPIED    0x02  // The PCAN-Channel handle is valid, but is already being used
#define PCAN_CHANNEL_UNOCCUPIED  0x03  // The PCAN-Channel handle is valid and ready for use (Plug & Play hardware only)
